...
_RESUME_SKILLS: set[str] = {
    ...
    # Frontend
    "react", "react.js", "next", "next.js", "tailwind", "tailwind css",
    "css", "vite", "electron", "html",
    # Backend & Cloud
    "node", "node.js", "bun", "elysia", "express", "express.js",
    "rest api", "rest apis", "postgresql", "postgres", "redis",
    "rabbitmq", "mongodb", "supabase", "cloudflare", "aws", "azure", "gcp",
    # Realtime
    "websockets", "yjs", "crdt", "durable objects",
    # AI/ML
    "langchain", "langgraph", "pgvector", "groq", "gemini", "openai",
    "deepgram", "vercel ai sdk",
    # Tools
    "git", "figma", "playwright",
}
...
_COMP_ANNUAL_RE = re.compile(
    r"\b(annual|per year|per annum|yearly|a year|annum|/yr)\b", re.I
)
_COMP_MONTHLY_RE = re.compile(
    r"\b(monthly|per month|a month|per mo|/mo|/month)\b", re.I
)
...
_FIRST_WORLD_COUNTRIES: frozenset[str] = frozenset({
    ...
    "sweden", "norway", "denmark", "finland", "iceland", "italy", "spain",
    "portugal", "greece", "luxembourg", "israel", "australia", "new zealand",
    "japan", "south korea", "singapore", "taiwan", "hong kong",
    "united arab emirates", "qatar", "saudi arabia", "czech republic",
    "poland", "hungary", "estonia", "latvia", "lithuania", "slovakia",
...
_THIRD_WORLD_COUNTRIES: frozenset[str] = frozenset({
    "india", "vietnam", "thailand", "indonesia", "philippines", "malaysia",
    "brazil", "mexico", "argentina", "chile", "colombia", "peru",
    "egypt", "nigeria", "kenya", "morocco", "south africa", "turkey",
    "china", "bangladesh", "pakistan", "sri lanka", "nepal",
})
...
_OFFICE_SUFFIX_RE = re.compile(
    r"\b(office|hq|headquarters|campus|site|location|hub)\b", re.I
)
...
class ScreenerRAG:
    ...
    def target_country(
        ...
        if job_context:
            for field in ("location", "description"):
                ...
                country = (
                    _country_from_location(src)
                    if field == "location"
                    else _country_from_text(src)
                )
                if country:
                    return country
        return None
    ...
    def _proficiency_answer(
        ...
        # technology.
        if re.match(r"^(building|developing|working as|being|leading|designing|working in|working on)", tail):
            return None
        ...
        noise = {
            "in", "with", "one", "of", "our", "primary", "languages", "the",
            "a", "an", "and", "required", "role", "this", "do", "you", "have",
            "strong", "technology", "technologies", "previous", "internships",
            "demonstrated", "experience", "any", "or", "list", "from", "their",
            "they", "following", "these", "those", "both", "such", "as",
            "including", "e.g", "eg", "etc", "database", "databases",
            "platform", "platforms", "tools", "tool", "stack", "language",
        }
        ...
        non_tech = {
            "leadership", "team", "teams", "management", "people", "company",
            "companies", "culture", "industry", "role", "roles", "client",
            "clients", "customers", "customer", "business", "businesses",
            "project", "projects", "product", "products", "service",
            "services", "community", "communication", "collaboration",
            "writing", "research", "mentoring", "hiring", "recruiting",
            "interviewing", "marketing", "sales", "finance", "financial",
            "agile", "scrum", "ownership", "workflow", "workflows",
            "environment", "environments", "production", "deployment",
            "infrastructure", "architecture", "design", "designing",
            "building", "developing", "solving", "problem", "problems",
            "task", "tasks", "area", "areas", "field", "domains", "domain",
            "topic", "topics", "part", "parts", "aspect", "aspects",
            "delivery", "quality", "security", "performance", "scalability",
            "reliability", "testing", "automation", "optimization",
            "insurance", "healthcare", "banking", "retail", "education",
            "legal", "government", "energy", "automotive", "medical",
            "pharmaceutical", "logistics", "travel", "hospitality", "media",
            "entertainment", "gaming", "real estate", "manufacturing",
            "telecommunications", "agriculture", "aerospace", "defense",
            "advertising", "consulting", "recruitment", "hr", "operations",
            "supply chain", "accounting", "payments", "compliance",
        }
        ...
        known_non_resume_tech = {
            "kubernetes", "docker", "go", "terraform", "gke", "gitops",
            "kafka", "spark", "hadoop", "airflow", "jenkins", "ansible",
            "puppet", "chef", "helm", "prometheus", "grafana", "k8s",
            "neo4j", "graphql", "grpc", "kotlin", "swift", "ruby", "php",
            "scala", "haskell", "clojure", "elixir", "erlang", "perl",
            "dart", "flutter", "angular", "svelte", "vue", "jquery",
            "backbone", "ember", "sass", "less", "bootstrap", "material ui",
            "chakra", "redux", "mobx", "zustand", "react native", "solidity",
            "ethereum", "bitcoin", "tensorflow", "pytorch", "keras",
            "scikit", "opencv", "nltk", "spacy", "huggingface", "transformers",
            "fastapi", "django", "flask", "rails", "spring", "laravel",
            "symfony", "asp.net", "dotnet", "c#", "csharp", "cuda",
            "opengl", "unity", "unreal", "blender", "maya", "figma",
            "photoshop", "illustrator", "kibana", "logstash", "elasticsearch",
            "redis cloud", "mongo db atlas", "cassandra", "couchdb",
            "dynamodb", "firebase", "vercel", "netlify", "heroku", "fly.io",
            "railway", "digitalocean", "linode", "vultr", "expo", "capacitor",
        }
        ...
        low_full = full.lower()
        multi_hits = {
            s for s in _RESUME_SKILLS if " " in s and s in low_full
        }
        ...
        if "both" in tokens:
            ...
            ok = bool(candidates) and all(s in _RESUME_SKILLS or s in multi_hits for s in candidates)
    ...
    def resolve_residence_policy(
        ...
        if _WILLING_COMPLEMENT_RE.search(ql) and options and any(
            _WILLING_OPTION_RE.search(o or "") for o in options
        ):
            return None
