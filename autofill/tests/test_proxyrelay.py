    ...
    def _handle(self, conn) -> None:
        try:
            ...
            if method == "CONNECT":
                ...
                sock.sendall(request_line + headers.split(b"\r\n\r\n")[0].replace(b"Proxy-Authorization: " + b"Basic " + expected.encode(), b"") + b"\r\n\r\n")
...
async def test_relay_injects_auth_and_tunnels_https() -> None:
    ...
    echo = await asyncio.start_server(
        lambda r, w: w.write(b"hello-from-origin"), "127.0.0.1", 0
    )
