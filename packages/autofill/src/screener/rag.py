...
from autofill.src.screener.evidence_graph import EvidenceGraph
from autofill.src.screener.profile import Profile

logger = get_logger("autofill.src.screener.rag")

ROOT = Path(__file__).resolve().parent.parent
PERSONA_JSON = Path(__file__).resolve().parents[4] / "data" / "persona.json"
PERSONA_TXT = Path(__file__).resolve().parents[4] / "data" / "persona.txt"
