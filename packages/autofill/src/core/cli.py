...
from autofill.src.core.worker import _per_job_resume, is_overnight, run_worker
...
async def _stream_runner(
    ...
    """
    node_dir = str(Path(__file__).resolve().parents[4] / "packages" / "node")
    print(
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    print(
                                        ...
                                        f"`python -m autofill.src.filling.resume {deferred_id}`"
                                    )
