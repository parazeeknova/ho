...
MATCH_PROMPT = (
    ...
    "IMPORTANT: The candidate is an early-career / new-grad / intern based "
    "in India. Accept remote roles worldwide, onsite roles in India, and "
    "roles offering visa sponsorship. Extract the salary if present in the "
    "job description — if the listing specifies a salary below 70K INR per "
    "month (or equivalent), set match_percent to 0 and verdict to NO_MATCH.\n"
